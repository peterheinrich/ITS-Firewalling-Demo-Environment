...
in-target /bin/sh -c -- 'echo "    address 172.17.0.1" >> /etc/network/interfaces'
...
in-target /bin/sh -c -- 'echo "    address 192.168.111.2" >> /etc/network/interfaces'
...
in-target /bin/sh -c -- 'echo "    gateway 192.168.111.1" >> /etc/network/interfaces'
